...
%>
<body onload="init();getparm1()" class="hold-transition skin-red sidebar-mini">
	<div class="wrapper">
<script language="javascript" type="text/javascript">
		...
		<header class="main-header"> <!-- Logo --> <a
			href="index2.html" class="logo"> <span class="logo-mini"><b>A</b>LT</span>
			<span class="logo-lg"><b>Admin</b>LTE</span>
		</a> <!-- Header Navbar --> <nav class="navbar navbar-static-top"
			role="navigation"> <!-- Sidebar toggle button--> <a href="#"
			class="sidebar-toggle" data-toggle="offcanvas" role="button"> <span
			class="sr-only">Toggle navigation</span>
		</a> <!-- Navbar Right Menu 右侧栏-->
		...
		<!-- 左侧栏Left side column. contains the logo and sidebar -->
		<aside class="main-sidebar"> <!-- sidebar: style can be found in sidebar.less -->
		<section class="sidebar"> <!-- 用户面板Sidebar user panel (optional) -->
		...
		<ul class="sidebar-menu">
			...
			<li class="active"><a href="javascript:void(0);"
				onclick="showPage(0,0);"><i class="fa fa-link"></i> <span>Link</span></a></li>
			<li><a href="javascript:void(0);" onclick="showPage(1,0);"><i class="fa fa-link" ></i> <span>Another
						Link</span></a></li>
	...
	<script type="text/javascript" src="js/collections/tests.js"></script>
